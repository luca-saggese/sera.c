...
// q3_ggml_stubs.h - minimal ggml-API stubs for ds4's vendored mmq kernels.
//
...
/* ------------------------------------------------------------------ *
 * q3 persistent scratch arena.
 *
 * Attached once by cuda/q3_mmq.cu so the Q4_K dense hot path allocates
 * nothing per call: every transient buffer (Q8_1 activation staging,
 * stream-K fixup scratch) is sliced out of this single arena.
 * ------------------------------------------------------------------ */
extern unsigned char * q3_arena_base;
extern size_t          q3_arena_capacity;
extern size_t          q3_arena_cursor;
